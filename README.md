...
- **Centro multimedia** usando *Kodi v17.3 "Krypton"*
- **Centro de juegos y emuladores** usando *RetroPie 4.2*
- **Centro de juegos en streaming** usando *Moonlight 2.4.2*
- **Centro de streaming multimedia** usando *MiniDLNA*
- **Centro de descargas** usando *Transmission*
- **Estación de trabajo** con *Pixel*
...
- Tarjeta **microSD SDHC** 32Gb, recomiendo [SanDisk SDSQXNE-032G-GN6AA](https://www.amazon.es/SanDisk-Ultra-microSDHC-adaptador-velocidad/dp/B013UDL5RU/ref=sr_1_1?ie=UTF8&qid=1499419256&sr=8-1&keywords=sandisk+32gb)
...
**Mediacenter Kodi 17.3 Krypton**, *compilación arm7*  
...
- Protocolos **SSH** y **SMB** (Samba) habilitados (usuario = **pi** / password = **raspberry**)
- Kodi con Skin **Estuary**
...
# PASO 1: Instalación
1. Descargar la imágen preconfigurada [**mediabox17-3.rar**](https://www.dropbox.com/s/6buej24la82wnu8/mediabox17-3.rar?dl=0)
...
5. La Raspberry se encenderá, aparecerá la imágen inicial de *juegos antigüos*
6. La Raspberry se **reiniciará automáticamente**, volverás a ver la imagen inicial de *juegos antigüos*
7. El mediacenter **Kodi** arrancará automáticamente
8. Pulsamos el botón situado en la *esquina inferior izquierda*, seleccionamos **salir** para cerrar **Kodi** y salir a **Emulationstation**

### Hash del fichero mediabox17-3.rar
```
...
| Campo | Significado |
|---|---|
| "download-dir": "/home/pi/Downloads", | Ruta de descarga por defecto |
| "rpc-authentication-required": true, | Proteger acceso a tranmission con password |
| "rpc-password": "pi", | Password para acceder a transmission |
| "rpc-username": "pi", | Usuario para acceder a transmission |
...
Para ello simplemente escribe la dirección **\\\\MEDIABOX** Desde aquí podrás transferir ficheros y configuraciones, así como **roms de juegos** para RetroPie
